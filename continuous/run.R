...
results_NLR[,1]=ATE_NLR
results_LR[,1]=ATE_LR
results_all[,1]=ATE_all
...
for(m in 1:M){
  ...
  # CI and coverage
  results_NLR[m,3:6]=output(results_NLR[m,2],MLE$SE[1],ATE_NLR)
  results_LR[m,3:6]=output(results_LR[m,2],MLE$SE[2],ATE_LR)
  results_all[m,3:6]=output(results_all[m,2],MLE$SE[3],ATE_all)
  ...
  # CI and coverage
  results_NLR[m,7:10]=output(results_NLR[m,2],se_NLR,ATE_NLR)
  results_LR[m,7:10]=output(results_LR[m,2],se_LR,ATE_LR)
  results_all[m,7:10]=output(results_all[m,2],se_all,ATE_all)
}
